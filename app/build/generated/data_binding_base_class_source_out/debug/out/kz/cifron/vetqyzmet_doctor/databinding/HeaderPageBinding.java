...
public final class HeaderPageBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static HeaderPageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static HeaderPageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.header_page, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static HeaderPageBinding bind(@NonNull View rootView) {
