...
public final class DialogBottomSheetAnimalColorBinding implements ViewBinding {
  @NonNull
  ...
  private DialogBottomSheetAnimalColorBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull RadioButton option4, @NonNull RadioGroup radioGroup, @NonNull View separator1,
      @NonNull View separator2, @NonNull View separator3, @NonNull View separator4,
  ...
  @NonNull
  public static DialogBottomSheetAnimalColorBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogBottomSheetAnimalColorBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_bottom_sheet_animal_color, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogBottomSheetAnimalColorBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogBottomSheetAnimalColorBinding((ConstraintLayout) rootView, buttomClose,
          confirmButton, option1, option2, option3, option4, radioGroup, separator1, separator2,
          separator3, separator4, textTop);
    }
